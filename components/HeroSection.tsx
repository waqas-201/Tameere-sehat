...
export default function HeroSection({
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative bg-[#0b241b] text-white py-12 sm:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        
        {/* Ambient Solid Background Accents */}
        <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 rounded-full bg-emerald-900/30 blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-96 h-96 rounded-full bg-stone-900/40 blur-3xl pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 sm:space-y-8 text-left">
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-900/60 border border-emerald-500/30 text-emerald-300 text-xs font-semibold tracking-wide">
                ...
                <span className="text-amber-200">{language === 'ur' ? '34 سالہ طبی ورثہ' : '34 Years Legacy'}</span>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1">
                <button
                  onClick={onShopClick}
                  className="px-6 py-3.5 rounded-xl bg-[#199b50] hover:bg-[#158242] text-white font-bold text-xs sm:text-sm tracking-wide shadow-md transition-all flex items-center gap-2 border border-emerald-500"
                >
                ...
                <button
                  onClick={onOpenMizaj}
                  className="px-5 py-3.5 rounded-xl bg-stone-900/80 hover:bg-stone-800 text-stone-100 font-bold text-xs sm:text-sm tracking-wide transition-all flex items-center gap-2 border border-stone-700/80 hover:border-emerald-500/50 backdrop-blur-md"
                >
                ...
                <a
                  ...
                  className="px-4 py-3.5 rounded-xl bg-emerald-950/80 hover:bg-emerald-900 text-emerald-300 font-semibold text-xs sm:text-sm transition-all flex items-center gap-2 border border-emerald-800/60"
                >
              ...
              <div className="pt-4 border-t border-emerald-900/60 flex flex-wrap items-center gap-6 sm:gap-10 text-stone-300">
                <div>
                  <div className="text-xl sm:text-2xl font-black text-white font-serif">100,000+</div>
                  <div className="text-xs text-stone-400">Treated Patients</div>
                </div>
                ...
                <div>
                  ...
                  <div className="text-xs text-stone-400">18,400+ Verified Reviews</div>
                </div>
                <div className="w-px h-8 bg-emerald-900/60 hidden sm:block" />
                <div className="hidden sm:block">
                  <div className="text-xl sm:text-2xl font-black text-emerald-300 font-serif">100%</div>
                  <div className="text-xs text-stone-400">Steroid-Free Guarantee</div>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="w-full max-w-md bg-white text-stone-900 rounded-3xl p-5 sm:p-6 shadow-2xl shadow-emerald-950/60 border border-emerald-500/20 relative overflow-hidden group">
                
                {/* Top Badge Strip */}
                <div className="flex items-center justify-between gap-2 mb-3">
                  <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-50 text-[#155e42] text-[11px] font-bold uppercase tracking-wider">
                ...
                <div 
                  ...
                  className="relative aspect-4/3 rounded-2xl overflow-hidden bg-stone-100 mb-4 cursor-pointer"
                >
                  <img
                  ...
                  />
                  <div className="absolute top-2.5 right-2.5 bg-[#0e2a1f]/85 text-emerald-300 text-[10px] font-bold px-2.5 py-1 rounded-full backdrop-blur-xs flex items-center gap-1">
                ...
                <div className="space-y-2">
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      <h3 
                        onClick={() => onQuickView && onQuickView(heroSpotlightProduct)}
                        className="font-serif font-bold text-lg sm:text-xl text-stone-900 hover:text-[#155e42] cursor-pointer transition-colors leading-tight"
                      >
                    ...
                    <div className="text-right">
                      <div className="text-xl font-black text-[#155e42]">
                  ...
                  <div className="grid grid-cols-2 gap-2 pt-3">
                    <button
                      ...
                      className="py-2.5 px-3 rounded-xl bg-[#199b50] hover:bg-[#158242] text-white font-bold text-xs flex items-center justify-center gap-1.5 shadow-md shadow-emerald-900/10 transition-all active:scale-95"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="py-2.5 px-3 rounded-xl bg-stone-900 hover:bg-stone-800 text-white font-bold text-xs flex items-center justify-center gap-1.5 transition-all"
                    >
                      <MessageSquare className="w-4 h-4 text-emerald-400" />
      ...
      <section className="bg-stone-100/90 border-b border-stone-200/80 py-6 px-4">
        <div className="max-w-7xl mx-auto">
          
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
            <div>
              <div className="text-[11px] font-bold text-[#155e42] uppercase tracking-widest flex items-center gap-1.5">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="text-xs font-bold text-[#155e42] bg-white hover:bg-emerald-50 px-3 py-1.5 rounded-lg border border-stone-200 flex items-center gap-1.5 transition-colors shadow-2xs"
              >
                <Sparkles className="w-3.5 h-3.5 text-[#199b50]" />
                <span>{language === 'ur' ? 'ذاتی نسخہ تیار کریں' : 'Compounding Mixer'}</span>
              </button>

              <button
                onClick={onOpenConsultation}
                className="text-xs font-bold text-stone-700 bg-white hover:bg-stone-50 px-3 py-1.5 rounded-lg border border-stone-200 flex items-center gap-1.5 transition-colors shadow-2xs"
              >
            ...
            {wellnessNeeds.map((need, idx) => {
              ...
              return (
                <div
                  ...
                  className="p-4 rounded-2xl bg-white border border-stone-200/90 hover:border-[#199b50] shadow-2xs hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between"
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="w-10 h-10 rounded-xl bg-emerald-50 text-[#155e42] group-hover:bg-[#155e42] group-hover:text-white transition-colors flex items-center justify-center">
                      <Icon className="w-5 h-5" />
                    </div>
                    <span className="text-[10px] font-bold uppercase tracking-wider text-stone-500 bg-stone-100 group-hover:bg-emerald-100 group-hover:text-[#155e42] px-2 py-0.5 rounded-md transition-colors">
                      {need.tag}
                    </span>
                  </div>

                  <div>
                    <h4 className="font-bold text-xs sm:text-sm text-stone-900 group-hover:text-[#155e42] transition-colors">
      ...
      <div className="bg-[#0e2a1f] text-stone-200 py-3.5 px-4 text-xs border-y border-emerald-950/60">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 text-stone-300">
            ...
            <span className="hidden sm:inline text-stone-400">Zero Synthetic Adulterants</span>
          </div>

          <div className="flex items-center gap-4 sm:gap-6 text-stone-300 font-medium">
