    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6 animate-in fade-in">
      ...
      <div className="bg-white rounded-3xl max-w-3xl w-full overflow-hidden shadow-2xl border border-stone-200 relative animate-in zoom-in-95 duration-200">
        ...
        <button
          ...
          className="absolute top-4 right-4 z-20 w-9 h-9 rounded-full bg-white/90 text-stone-700 hover:bg-stone-100 flex items-center justify-center shadow-md transition-colors"
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-0">
          ...
          <div className="md:col-span-5 bg-stone-100 relative min-h-[260px] md:min-h-[420px] flex items-center justify-center p-4">
            <img
              src={product.image}
              alt={product.name}
            ...
            <div className="absolute top-4 left-4 flex flex-col gap-1 z-10">
              {product.badge && (
                <span className="bg-[#0e2a1f] text-emerald-300 text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full shadow-xs">
                  {product.badge}
                </span>
              )}
              {discountPercent && (
            ...
            {/* Temperament Tag */}
            <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-xs text-[#155e42] text-xs font-bold px-3 py-1 rounded-lg flex items-center gap-1.5 shadow-xs">
              <Leaf className="w-3.5 h-3.5 text-[#199b50]" />
          ...
          <div className="md:col-span-7 p-6 sm:p-7 flex flex-col justify-between space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-bold text-[#155e42] uppercase tracking-widest">
              ...
              <div className="flex items-baseline gap-3 pt-1">
                <span className="text-2xl sm:text-3xl font-black text-[#155e42] font-serif">
                ...
                <div className="flex items-center gap-2 border-b border-stone-100 pb-1.5">
                  <button
                    ...
                    className={`text-xs font-bold pb-1 transition-colors ${
                      activeTab === 'benefits' ? 'text-[#155e42] border-b-2 border-[#199b50]' : 'text-stone-400 hover:text-stone-700'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`text-xs font-bold pb-1 transition-colors ${
                      activeTab === 'ingredients' ? 'text-[#155e42] border-b-2 border-[#199b50]' : 'text-stone-400 hover:text-stone-700'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`text-xs font-bold pb-1 transition-colors ${
                      activeTab === 'dosage' ? 'text-[#155e42] border-b-2 border-[#199b50]' : 'text-stone-400 hover:text-stone-700'
                    }`}
                  >
            ...
            <div className="pt-3 border-t border-stone-100 space-y-2.5">
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className="py-3 px-4 rounded-xl bg-[#199b50] hover:bg-[#158242] text-white font-bold text-xs flex items-center justify-center gap-2 shadow-md transition-all active:scale-95"
                >
                ...
                <a
                  ...
                  className="py-3 px-4 rounded-xl bg-stone-900 hover:bg-stone-800 text-white font-bold text-xs flex items-center justify-center gap-2 transition-all"
                >
              ...
              <div className="text-center">
                <Link
                  ...
                  onClick={() => setQuickViewProduct(null)}
                  className="text-xs font-bold text-[#155e42] hover:underline inline-flex items-center gap-1"
                >
                  <span>{language === 'ur' ? 'مکمل صفحہ دیکھیں' : 'View Full Product Details & Reviews'}</span>
